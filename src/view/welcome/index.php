    ...
    <div class="login-div">
      ...
      <div class="fields">
        <div class="username"><svg class="svg-icon" viewBox="0 0 20 20">
						...
						</svg><input type="text" name="nomUtilisateur" id="nomUtilisateur"  onclick ="saisie('Nom d\'utilisateur',this.id)" onmouseout="retablir('Nom d\'utilisateur',this.id)" onblur="mev('Nom d\'utilisateur',this.id)" /></div>
        <div class="password"><svg class="svg-icon" viewBox="0 0 20 20">
						...
						</svg><input type="password" name="password" id="password" onclick ="saisie('password', this.id)" onmouseout="retablir('password',this.id)" onblur="mev('password',this.id)" /></div>
      </div>
      <input type="button" class="signin-button" value="Connecter" onclick="envoyer()"/>
      <div class="link">
