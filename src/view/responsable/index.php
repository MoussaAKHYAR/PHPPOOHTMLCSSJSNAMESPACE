...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/mesprojets/TD3HTMLCSSPHPNAMESPACEORM/public/css/banque.css" />
    <title>Banque</title>
</head>
<body>
    <header id="top" class="bg-white">
        <nav  class="flex-row">
            <div class="logo">
            <a href="#"><img src="http://localhost/mesprojets/TD3HTMLCSSPHPNAMESPACEORM/public/img/logo-Recupere.png" alt="logo banque du peuple" class="image"/></a>
            </div>
        <div class="texte plus-grand text-center">
            <h1 class="title-banque"> Banque du peuple </h1>
        </div>
        <div class="user-logo">
            <a href="#"><img src="http://localhost/mesprojets/TD3HTMLCSSPHPNAMESPACEORM/public/img/user.jpeg" alt="logo banque du peuple" class="image"/></a>
        </div>
        </nav>
    </header>
    <main class="flex-row">
        ...
        <div class="info-user flex-row">
            ...
            <div class="site-bar">
                <div class="marge">
                    <img src="http://localhost/mesprojets/TD3HTMLCSSPHPNAMESPACEORM/public/img/compte.png" alt="ok" class="icone" />
        ...
        <section id="contain" class="plus-grand bg-white">
            <form action="http://localhost/mesprojets/TD3HTMLCSSPHPNAMESPACEORM/clientCompte/add" method="POST">
...
<script src="http://localhost/mesprojets/TD3HTMLCSSPHPNAMESPACEORM/public/js/banque.js"></script>
